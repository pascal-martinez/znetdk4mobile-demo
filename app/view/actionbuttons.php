...
<div id="show-action-button">
    ...
    <button class="w3-btn w3-section w3-mobile w3-orange" data-type="custom"><i class="fa fa-diamond fa-lg"></i>&nbsp;Toggle custom button</button>
</div>
<style>
...
<script>
    ...
    $(function(){
        ...
        function initButtonsForTheView() {
            z4m.action.addCustomButton('custom', 'fa-diamond', 'w3-orange', 'Custom button');
