...
<form id="znetdkm-upload-demo" class="w3-content w3-theme-light" novalidate data-zdk-submit="featurectrl:upload">
    <div class="w3-section">
        ...
        <div class="w3-section">
            <p class="no-selection w3-text-red"><i class="fa fa-exclamation-circle"></i>&nbsp;<b>No file selected.</b></p>
    ...
    $('#znetdkm-upload-demo button.upload').on('click', function(){
        ...
        fileInput.off('change').one('change', function(){            
            ...
            for (let i = 0; i < selectedFiles.length; i++) {
                ...
                selectionContainer.append('<span class="w3-tag w3-round-large w3-theme w3-margin-right"><i class="fa fa-file-o"></i>&nbsp;' + currentFile.name + '</span>');
            }
            // Form error message hidden if displayed
